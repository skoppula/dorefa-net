...
flags.DEFINE_integer('bit_w', 31, 'Bitwidth of weights')
flags.DEFINE_integer('bit_a', 31, 'Bitwidth of activations')
...
flags.DEFINE_string('output', './train_logs_rsr_quantized_31bit_all_weight_layernorm_clipon/', 'Directory with model output')
    ...
    def _build_graph(self, inputs):
        ...
        with remap_variables(new_get_variable), \
            ...
            logits = (curr_layer.FullyConnected('fc' + str(FLAGS.n_layers), 256)
                      .LayerNorm('lnfc' + str(FLAGS.n_layers))
                      .apply(nonlin)
