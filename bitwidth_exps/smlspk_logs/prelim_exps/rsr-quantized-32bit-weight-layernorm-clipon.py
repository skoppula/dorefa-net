...
flags.DEFINE_string('output', './train_logs_rsr_quantized_32bit_weight_layernorm_clipon/', 'Directory with model output')
...
class Model(ModelDesc):
    ...
    def _build_graph(self, inputs):
        ...
        def new_get_variable(v):
            ...
            elif not name.endswith('W') or 'fc0' in name or 'fct' in name:
                return v
            else:
                logger.info("Binarizing weight {}".format(v.op.name))
                return fw(v, FLAGS.force_quantization)
