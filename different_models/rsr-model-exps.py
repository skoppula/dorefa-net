...
flags.DEFINE_integer('num_epochs', 30, 'Number of steps to run trainer.')
...
flags.DEFINE_string('output', './train_logs_a32_w32/', 'Directory with model output')
...
class Model(ModelDesc):
    def __init__(self, n_spks, model_type='fc'):
        super(Model, self).__init__()
        self.n_spks = n_spks
        assert model_type == 'fc' or model_type == 'cnn' or model_type == 'lc' or model_type=='maxout'
