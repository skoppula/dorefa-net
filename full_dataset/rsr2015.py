...
class WholeUtteranceAsBatchRsr2015(RsrMfccFiles):
    ...
    follow the same ordering of utterances as the index
    """
    def __init__(self, base_dir, partition, context=20, n_mfccs=20, include_dd=False, shuffle=True):
